...
This repository contains the python script to generate [my homepage](https://thetushar.tech/). It is very easy to adapt to your needs, and easy to maintain as the papers are crawled automatically from `publication_list.bib` and the talks from `talk_list.bib`.
